...
// // Mock class for testing purposes, to avoid calling the ChatGPT api and get
// blocked
// @Service
// public class ChatServiceMock {

// public Optional<PromptResponse<IndexTransfer>> execute(String request,
// Class<IndexTransfer> targetClass) {

// return Optional.of(mockIndex());
// }

// public Optional<PromptResponse<SlideText>> executeWithConversation(String
// request, Class<SlideText> targetClass,
...
// PromptResponse<IndexTransfer> response = new
// PromptResponse<IndexTransfer>(index, null, null, null);
...
// PromptResponse<SlideText> response = new PromptResponse<SlideText>(text,
// null, null, null);
